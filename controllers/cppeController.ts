/**
 * controllers/cppeController.ts — Module 3
 *
...
const calcProgress = (modules: any[] = []) => {
...
/* ─── GET ────────────────────────────────────────────────── */
export const getCPPE = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // @ts-ignore
...
/* ─── UPDATE ─────────────────────────────────────────────── */
export const updateCPPE = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const merged: any   = { ...DEFAULT_CPPE, ...(before.cppeStatus || {}), ...incoming };
