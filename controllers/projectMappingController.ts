...
export const getProjectMappings = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // @ts-ignore
...
export const createProjectMapping = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // @ts-ignore
    const clinicianId = await assertClinicianAccess(req, req.params.id);
    const body = req.body || {};
...
export const updateProjectMapping = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // @ts-ignore
    const clinicianId = await assertClinicianAccess(req, req.params.id);
...
export const deleteProjectMapping = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // @ts-ignore
    const clinicianId = await assertClinicianAccess(req, req.params.id);
    const mappingId   = toId(req.params.mappingId);
