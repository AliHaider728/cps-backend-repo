 ...
 */
export const getComplianceDocs = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      active, category, applicableTo, mandatory,
      expirable, autoSendOnBooking, preStartRequired, search,
 ...
 * GET /api/compliance/documents/stats
 */
export const getComplianceDocStats = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * GET /api/compliance/documents/:id
 */
export const getComplianceDocById = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const createComplianceDoc = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
 ...
 */
export const updateComplianceDoc = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      name, description, category, applicableTo, displayOrder,
      mandatory, expirable, active,
 ...
 * DELETE /api/compliance/documents/:id
 */
export const deleteComplianceDoc = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getDocumentGroups = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
 ...
 * GET /api/compliance/groups/for-entity/:entityType
 */
export const getGroupsForEntity = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * GET /api/compliance/groups/:id
 */
export const getDocumentGroupById = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const createDocumentGroup = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
 ...
 */
export const updateDocumentGroup = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      name, description, displayOrder, active,
      applicableEntityTypes, documents,
 ...
 * DELETE /api/compliance/groups/:id
 */
export const deleteDocumentGroup = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const duplicateDocumentGroup = async (req: Request, res: Response, next: NextFunction) => {
  try {
