/**
 * lib/emailTemplates.ts — Module 3
 *
...
export interface WelcomePackContext {
  fullName?: string;
 ...
 *
 * @param {WelcomePackContext} ctx
 */
export const welcomePackTemplate = (ctx: WelcomePackContext = {}): EmailResult => {
...
export interface MobilisationPlanContext {
  fullName?: string;
  contractType?: string;
 ...
 *
 * @param {MobilisationPlanContext} ctx
 */
export const mobilisationPlanTemplate = (ctx: MobilisationPlanContext = {}): EmailResult => {
